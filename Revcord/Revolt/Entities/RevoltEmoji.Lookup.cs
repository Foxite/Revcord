...
public partial class RevoltEmoji {
	...
	public static IReadOnlyDictionary<string, string> EmojiNamesToUnicode { get; } = new Dictionary<string, string>() {
		{ "100", "💯" },
		{ "1234", "🔢" },
		{ "grinning", "😀" },
		{ "smiley", "😃" },
	...
	static RevoltEmoji() {
		var unicodeToEmojiNames = new Dictionary<string, string>();
		foreach ((string name, string unicode) in EmojiNamesToUnicode) {
			unicodeToEmojiNames.TryAdd(unicode, name);
		}

		UnicodeToEmojiNames = unicodeToEmojiNames;
	}
}
