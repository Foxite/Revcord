...
public class DiscordChatClient : ChatClient {
	...
	public DiscordChatClient(DiscordConfiguration configuration) {
		...
		DSharp.MessageDeleted += (_, args) => OnMessageDeleted(new EntityId(args.Message.Id));
		DSharp.MessageReactionAdded += (_, args) => OnReactionAdded(new DiscordMessage(this, args.Message), new DiscordEmoji(this, args.Emoji));
		DSharp.MessageReactionRemoved += (_, args) => OnReactionRemoved(new DiscordMessage(this, args.Message), new DiscordEmoji(this, args.Emoji));
